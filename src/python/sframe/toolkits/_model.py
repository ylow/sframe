...
import sframe._connect.main as glconnect
from sframe.data_structures.sframe import SFrame as _SFrame
import sframe.extensions as _extensions
from sframe.extensions import _wrap_function_return
from sframe.toolkits._internal_utils import _toolkit_serialize_summary_struct
from sframe.util import _make_internal_url
from sframe.toolkits._main import ToolkitError
from sframe._deps.minimal_package import _minimal_package_import_check
import sframe.util._file_util as file_util
import os
...
def _get_default_options_wrapper(
    ...
    def get_default_options_for_model(output_type="sframe"):
        ...
        :class:`~sframe.{module_name}.{python_class_name}`.
        ...
        See Also
        --------
        sframe.{module_name}.{python_class_name}.get_current_options
        ...
        .. sourcecode:: python
          ...
          >>> out_sframe = sframe.{module_name}.get_default_options()

          # dict formatted output suitable for JSON serialization.
          >>> out_json = sframe.{module_name}.get_default_options('json')
        """
        if sdk_model:
...
class Model(ExposeAttributesFromProxy):
    ...
    def save(self, location):
        ...
        loaded using the :py:func:`~sframe.load_model` method.
        ...
        ----------
        >>> model.save('my_model_file')
        >>> loaded_model = sframe.load_model('my_model_file')
        """
