...
# For example, it can now find sframe.recommender.PopularityModel.
import sframe
...
version = sframe.version_info.version
release = version
...
org_url = "https://github.com/apple/sframe"
...
man_pages = [("index", "sframe", u"Turi Create Documentation", [u"Turi"], 1)]
